...
func (c *Client) UploadOrUpdateFile(bucketId string, relativePath string, data io.Reader, contentType string, update bool) (*FileUploadResponse, error) {
...
func (c *Client) UpdateFile(bucketId string, relativePath string, data io.Reader, contentType string) (*FileUploadResponse, error) {
	return c.UploadOrUpdateFile(bucketId, relativePath, data, contentType, true)
}

func (c *Client) UploadFile(bucketId string, relativePath string, data io.Reader, contentType string) (*FileUploadResponse, error) {
